            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.absensi.update', $absen->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="siswa_id" class="form-select" required>
                            ...
                            @foreach ($siswa as $item)
                                <option value="{{ $item->id }}" {{ $absen->siswa_id == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            @if ($absen->foto_bukti)
                                <img src="{{ asset('storage/foto_absensi/' . $absen->foto_bukti) }}" alt="Foto Bukti"
                                    class="rounded border" width="160" style="object-fit: cover"
                                    onerror="this.src='{{ asset('template1/assets/img/no-image.png') }}'">
                            @else
                                <img src="{{ asset('template1/assets/img/no-image.png') }}" alt="Tidak ada foto"
                                    class="rounded border" width="160" style="object-fit: cover">
                            @endif
                        </div>
