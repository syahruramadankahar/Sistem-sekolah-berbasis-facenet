        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <h6 class="op-7 mb-2">Perbarui data galeri yang sudah ada</h6>
                </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-text text-muted mt-2">
                                        <i class="fas fa-info-circle me-1"></i>Biarkan kosong jika tidak ingin mengganti gambar. Format: JPG, PNG, JPEG. Maks: 2MB
                                    </div>
                                    @error('gambar')
                                        <div class="text-danger mt-2" style="font-size: 0.875rem;">
                                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                ...
                                <div class="card bg-light rounded-3 border-0">
                                    <div class="card-body">
                                        <h6 class="fw-bold text-dark mb-3">
                                            <i class="fas fa-edit me-2 text-primary"></i>Edit Informasi
                                        </h6>
                                        <p class="text-muted small mb-0">
                                            Perbarui data galeri sesuai kebutuhan. Gambar yang diupload akan menggantikan gambar lama.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-warning bg-opacity-10 rounded-3 border-0 mt-3">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted small mb-0">{{ $galeri->judul }}</p>
                                        </div>
                                    </div>
                                </div>
                                @endif
