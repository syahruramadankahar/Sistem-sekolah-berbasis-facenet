    ...
    <div class="container-fluid">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Data Galeri</h3>
                    <h6 class="op-7 mb-2">Kelola data galeri dengan mudah dan efisien</h6>
                </div>
                        ...
                        <table class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="15%">Uploader</th>
                            ...
                            <tbody>
                                @forelse($galeri as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($item->gambar)
                                                <img src="{{ asset('storage/' . $item->gambar) }}" 
                                                     alt="{{ $item->judul }}" 
                                                     class="rounded"
                                                     style="width: 120px; height: 80px; object-fit: cover; border: 2px solid #e5e7eb;">
                                            @else
                                        ...
                                        <td class="text-center text-dark">{{ $item->uploader->name ?? '-' }}</td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <form action="{{ route('admin.galeri.destroy', $item->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-icon btn-sm"
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus data galeri ini?')"
                                                        title="Hapus Galeri">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <h5 class="fw-bold">Belum ada data galeri</h5>
                                                <p>Silakan tambah data galeri terlebih dahulu</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
