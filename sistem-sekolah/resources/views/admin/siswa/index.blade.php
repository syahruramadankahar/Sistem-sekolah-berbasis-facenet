        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <h6 class="op-7 mb-2">Kelola data siswa dengan mudah dan efisien</h6>
                </div>
                <div class="ms-md-auto py-2 py-md-0">
                    <a href="{{ route('admin.siswa.create') }}" class="btn btn-primary btn-round">
            ...
            <div class="mb-4">
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('admin.siswa.excel') }}" class="btn btn-success btn-round">
                        <i class="fas fa-file-excel me-2"></i>Export Excel
                    </a>
                    <a href="{{ route('admin.siswa.pdf') }}" class="btn btn-danger btn-round">
                        ...
                        <table class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="12%">NIS</th>
                            ...
                            <tbody>
                                @forelse($siswa as $key => $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="text-primary fw-bold">{{ $item->nis }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="text-dark">{{ $item->kelas->nama_kelas ?? '-' }}</span>
                                        </td>
                                        <td class="text-center">
                                            <span class="text-success fw-bold">{{ $item->jurusan }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('admin.siswa.edit', $item->id) }}"
                                                    class="btn btn-warning btn-icon btn-sm" title="Edit Siswa">
