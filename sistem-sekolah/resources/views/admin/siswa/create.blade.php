        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <h6 class="op-7 mb-2">Tambahkan data siswa baru ke sistem</h6>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-text text-muted mt-2">
                                        <i class="fas fa-info-circle me-1"></i>Upload foto wajah siswa (format JPG/PNG, max 2 MB)
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="jurusan" class="form-control form-control-lg"
                                        value="{{ old('jurusan') }}" placeholder="Masukkan jurusan siswa" required
                                        style="border-radius: 8px; border: 2px solid #e5e7eb; padding: 12px 16px; font-size: 1rem; transition: all 0.3s ease;">
                                    <div class="form-text text-muted mt-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="alamat" rows="4" class="form-control form-control-lg" placeholder="Masukkan alamat lengkap siswa"
                                        style="border-radius: 8px; border: 2px solid #e5e7eb; padding: 12px 16px; font-size: 1rem; transition: all 0.3s ease; resize: vertical;">{{ old('alamat') }}</textarea>
                                    <div class="form-text text-muted mt-2">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light rounded-3 border-0">
                                    <div class="card-body">
                                        <h6 class="fw-bold text-dark mb-3">
                                            <i class="fas fa-info-circle me-2 text-primary"></i>Informasi Siswa
                                        </h6>
                                        <ul class="list-unstyled text-muted small mb-0">
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                Nama harus sesuai dokumen resmi
                                            </li>
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                NIS harus unik dan valid
                                            </li>
                                            <li class="mb-0">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                Pilih kelas dan jurusan yang sesuai
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-light rounded-3 border-0 mt-3">
                                    <div class="card-body">
                                        <h6 class="fw-bold text-dark mb-3">
                                            <i class="fas fa-lightbulb me-2 text-warning"></i>Contoh Format
                                        </h6>
                                        <ul class="list-unstyled text-muted small mb-0">
                                            <li class="mb-1">
                                                <span class="fw-semibold">Nama:</span>
                                            </li>
                                            <li class="mb-1">• Aulia Rahma</li>
                                            <li class="mb-1">• Rizky Pratama</li>
                                            <li class="mb-1">• Siti Nurhaliza</li>
                                            <li class="mt-2 mb-1">
                                                <span class="fw-semibold">NIS:</span>
                                            </li>
                                            <li class="mb-1">• 202501001</li>
                                            <li class="mb-1">• 202501002</li>
                                            <li class="mb-1">• 202501003</li>
                                            <li class="mt-2 mb-1">
