        ...
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    ...
                    <h6 class="op-7 mb-2">Kelola data berita dengan mudah dan efisien</h6>
                </div>
                                        ...
                                        <td class="text-center">
                                            @if($item->gambar)
                                                <img src="{{ asset('storage/' . $item->gambar) }}" 
                                                     alt="{{ $item->judul }}" 
                                                     class="rounded"
                                                     style="width: 100px; height: 70px; object-fit: cover; border: 2px solid #e5e7eb;">
                                            @else
                                                <span class="text-muted fst-italic">Tidak ada gambar</span>
                                            @endif
                                        </td>
                                        <td class="text-center text-dark">
                                            <span class="text-primary fw-bold">{{ $item->penulis->name ?? 'Tidak diketahui' }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('admin.berita.edit', $item->id) }}"
                                                    class="btn btn-warning btn-icon btn-sm" title="Edit Berita">
                                                ...
                                                <form action="{{ route('admin.berita.destroy', $item->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-icon btn-sm"
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus data berita ini?')"
                                                        title="Hapus Berita">
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <h5 class="fw-bold">Belum ada data berita</h5>
                                                <p>Silakan tambah data berita terlebih dahulu</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
