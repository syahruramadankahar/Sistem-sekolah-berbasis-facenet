    ...
    <div class="container-fluid">
        <div class="page-inner">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                <div>
                    <h3 class="fw-bold mb-3">Tambah Kelas</h3>
                    <h6 class="op-7 mb-2">Tambahkan kelas baru ke sistem</h6>
                </div>
                            ...
                            <div class="col-md-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="nama_kelas" class="form-control form-control-lg"
                                        value="{{ old('nama_kelas') }}" placeholder="Contoh: X TJKT 1" required
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="tingkat" class="form-control form-control-lg"
                                        value="{{ old('tingkat') }}" placeholder="Contoh: X, XI, XII" required
                                        style="border-radius: 8px; border: 2px solid #e5e7eb; padding: 12px 16px; font-size: 1rem; transition: all 0.3s ease;">
                                    <div class="form-text text-muted mt-2">
                            ...
                            <div class="col-md-4">
                                <div class="card bg-light rounded-3 border-0">
                                    <div class="card-body">
                                        <h6 class="fw-bold text-dark mb-3">
                                            <i class="fas fa-info-circle me-2 text-primary"></i>Informasi Kelas
                                        </h6>
                                        <ul class="list-unstyled text-muted small mb-0">
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                Nama kelas harus unik dan deskriptif
                                            </li>
                                            <li class="mb-2">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                            ...
                                            <li class="mb-0">
                                                <i class="fas fa-check-circle text-success me-2"></i>
                                                Tingkat kelas menggunakan angka romawi
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card bg-light rounded-3 border-0 mt-3">
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled text-muted small mb-0">
                                            <li class="mb-1">
                                                <span class="fw-semibold">Nama Kelas:</span>
                                            </li>
                                            <li class="mb-1">• X TJKT 1</li>
                                            <li class="mb-1">• XI MPLB 2</li>
                                            <li class="mb-1">• XII DPIB 1</li>
                                            <li class="mt-2">
                                                <span class="fw-semibold">Tingkat:</span>
                                            </li>
                                            <li>• X, XI, XII</li>
                                        </ul>
                                    </div>
